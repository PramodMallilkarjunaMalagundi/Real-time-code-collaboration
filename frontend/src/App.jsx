...
function App() {
  ...
  // CORRECTED: Reliably stores our own socket ID to prevent race conditions
  ...
  useEffect(() => {
    ...
    // CORRECTED: This is the most reliable way to get our own ID.
    // It fires once the connection is successfully established.
    socket.on('connect', () => {
    ...
    socket.on('lock-status-update', ({ lockedBy, username }) => {
      ...
      // CORRECTED: This check now reliably uses the state variable for our ID.
  ...
  return (
    <div className="editor-container">
      <div className="sidebar">
        ...
        {/* UPDATED: Simplified UI for lock status, now using the `<strong>` tag */}
